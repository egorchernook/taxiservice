    ...
    <main>
        ...
        <section>
            <form class="form-column" action>
                ...
                <label class="input-label" for="car_number">
                    <span class="input-title">Номер автомобиля</span>
                </label>
                <input class="input" type="text" name="car_number" id="car_number" placeholder="B004KA 77">

                <label class="input-label" for="phone_number">
                    <span class="input-title">Серия и номер паспорта</span>
                </label>
                <input class="input" type="text" name="passport_number" id="passport_number" placeholder="00 00 000000">
